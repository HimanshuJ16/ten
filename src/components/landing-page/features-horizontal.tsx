...
import { BorderBeam } from "@/components/landing-page/magicui/border-beam";
          ...
          <div className="">
                  ...
                  >
                    {linePosition === "left" || linePosition === "right" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-top bg-blue-500 transition-all ease-linear dark:bg-white`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    {linePosition === "top" || linePosition === "bottom" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-left bg-blue-500 transition-all ease-linear dark:bg-white`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    <AccordionTrigger>
                      <div className="flex items-center relative flex-col">
                        <div className="item-box size-16 bg-blue-500/10 rounded-full sm:mx-6 mx-2 shrink-0 flex items-center justify-center">
                          {item.icon}
                        </div>
            ...
            >
              ...
              <BorderBeam
                ...
                delay={9}
                borderWidth={1.5}
                colorFrom="hsl(217 91% 60%)"  // Tailwind blue-500
                colorTo="hsl(217 91% 60% / 0)" 
              />
            </div>
